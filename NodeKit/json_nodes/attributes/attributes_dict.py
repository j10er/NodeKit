                ...
                },
                {
                    "NodeInternal": [
                        {},
                        {
                            "CompositorNode": [
                                {},
                                {
                                    ...
                                    "CompositorNodeCornerPin": [
                                        {"interpolation": ["ENUM", "ANISOTROPIC"]}
                                    ],
                                    "CompositorNodeCrop": [
                                        {
                                            "max_x": ["INT", 0],
                                    ...
                                    "CompositorNodeFilter": [
                                        {"filter_type": ["ENUM", "SOFTEN"]}
                                    ],
                                    "CompositorNodeFlip": [{"axis": ["ENUM", "X"]}],
                                    "CompositorNodeGamma": [{}],
                                    "CompositorNodeGlare": [
                                        {
                                    ...
                                    "CompositorNodeInpaint": [{"distance": ["INT", 0]}],
                            ...
                            "NodeFrame": [
                                {"label_size": ["INT", 12], "shrink": ["BOOLEAN", True]}
                            ],
                            "ShaderNode": [
                                {},
                                {
